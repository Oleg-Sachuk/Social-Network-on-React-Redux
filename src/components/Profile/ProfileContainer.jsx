...
import { getProfileThunk, updateUsersStatus, getUsersStatus } from "./../../redux/profile-reducer";
...
export default compose(connect(mapStateToProps,{getProfileThunk, updateUsersStatus, getUsersStatus}),
