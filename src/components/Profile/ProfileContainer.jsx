...
import { getProfileThunk, updateUsersStatus, getUsersStatus, savePic } from "./../../redux/profile-reducer";
...
export default compose(connect(mapStateToProps,{getProfileThunk, updateUsersStatus, getUsersStatus,savePic}),
